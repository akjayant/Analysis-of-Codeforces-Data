...
//int question, N, buihoatpjkgfjsafdgjsngbngnnagn[MAXN];
//main() {
//    FASTIOS;
//#ifndef ONLINE_JUDGE
...
//        sort(buihoatpt + 1, buihoatpt + N + 1);
//        int RES = 1;
//        for (int i = 1; i <= N; ++i) {
//            RES=max(RES,min(buihoatpjkgfjsafdgjsngbngnnagn[i], N-i+1));
//        }
//        cout<<RES<<'\n';
//    }
//}
...
main() {
    ...
    cin >> TEST;
    while (TEST--) {
        cin >> N >> jsgjkjsgkjj >> jkgfjsafdgjsngbngnnagn;
        if (CHECK())
            cout << "YES" << "\n";
        else
            cout << "NO" << "\n";
