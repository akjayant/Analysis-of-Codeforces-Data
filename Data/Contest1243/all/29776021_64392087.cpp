...
template <typename A, typename B>
ostream &operator<<(ostream &os, vector<pair<A, B>> &v)
{
    for (auto p : v)
        cout << p << endl;
    return os;
...
template <typename A, typename B>
ostream &operator<<(ostream &os, map<A, B> &mp)
{
    for (auto it : mp)
...
template <typename A>
ostream &operator<<(ostream &os, set<A> &st)
{
    for (A p : st)
        cout << p << " ";
    return os;
...
template <typename A>
istream &operator>>(istream &is, vector<A> &v)
{
    for (A &p : v)
        is >> p;
    return is;
...
template <typename A, typename B>
istream &operator>>(istream &is, vector<pair<A, B>> &v)
{
    for (auto &p : v)
        is >> p.first >> p.second;
    return is;
...
template <typename A, typename B>
inline void output(pair<A, B> &p) { cout << "{" << p.first << ", " << p.second << "}" << endl; }
template <typename A, typename B>
inline void output(map<A, B> &mp)
{
    cout << endl;
    for (auto it : mp)
...
template <typename A, typename B>
inline void output(vector<pair<A, B>> &v)
{
    cout << endl;
    for (auto p : v)
