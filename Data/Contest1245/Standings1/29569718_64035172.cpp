...
public:
	void solve(std::istream& cin, std::ostream& cout) {
        ...
        long double dp[10][10];//with ladder
        long double dp1[10][10];//without ladder
        dp[0][1]=6;
        dp[0][2]=6;
        dp[0][3]=6;
        dp[0][4]=6;
        ...
        long double last[6]={6,6,6,6,6,6};
        ...
        for(int i=1;i<10;i++){
            ...
            if(i%2==1){
                for(int j=9;j>=0;j--){
                    ...
                    dp1[i][j]=sum;
                    if(h[i][j]!=0){
                        //compute where this ladder will take you
                        sum=min(sum, dp1[i-h[i][j]][j]);
                    }
                    dp[i][j]=sum;
                    for(int j=5;j>0;j--)
                        last[j]=last[j-1];
